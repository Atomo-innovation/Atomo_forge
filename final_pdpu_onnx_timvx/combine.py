...
# ====================== PERSON CONFIG ======================
# YOLOv3 ASNN constants from your original script
GRID0 = 20
GRID1 = 40
GRID2 = 80
LISTSIZE = 65
...
# ====================== YOLOv3 HELPER FUNCTIONS (from your original) ======================
def sigmoid(x):
    return 1 / (1 + np.exp(-x))
...
class CombinedPipeline:
    def __init__(self, cam_name: str, rtsp_url: str, save_dir=None):
        ...
        self._writer = None
        self.net = None          # Fire model
        self.yolov3 = None       # Person model
...
def main():
    ...
    try:
        while True:
            if args.display:
                # Simple display can be added here if needed (left minimal for performance)
                time.sleep(0.05)
            else:
                time.sleep(0.1)
